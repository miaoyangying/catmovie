        ...
        data(){
            return {
                songs:{
                    "title": "孤独患者",
                    "artist": "陈奕迅",
                    "src": "http://www.170mv.com/kw/antiserver.kuwo.cn/anti.s?rid=MUSIC_40371942&response=res&format=mp3|aac&type=convert_url&br=128kmp3&agent=iPhone&callback=getlink&jpcallback=getlink.mp3",
